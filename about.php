	...
	<div class="container">
        ...
        <div class="col-lg-1"></div>
            <div class="col-lg-7">
                ...
                <p>Well, the explanation's pretty simple. My first name and two last names are a bit awkward looking mashed together in a username: <em>leamaroltsonnenschein</em><br>
